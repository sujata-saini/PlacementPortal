...
//   // function to match company job applisn data
...
//                   type="checkbox"
//                   defaultChecked
//                   className="w-4 h-4 accent-blue-500 cursor-pointer" checked ={job.visible}
//                 />
//               </td>
//             </tr>
//           ))}
...
//       <div className="mt-4">
//         <button  onClick={()=>navigate('/dashboard/add-job')}className="bg-black text-white px-5 py-2 rounded hover:bg-gray-800 transition">
//           Add new job
//         </button>
//       </div>
//     </div>
