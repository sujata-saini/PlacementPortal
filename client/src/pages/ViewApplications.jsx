...
// const {data} = await axios.post(backenUrl + '/api/company/change-status',
...
//               <td className="p-3 text-gray-700">{applicant.jobId.location}</td>
//               <td className="p-3">
//                 <a
...
//                     <button  onClick ={()=>changeJobApplicationStatus(applicant._id, ' Accepted')}className="w-full text-left px-3 py-2 text-green-600 hover:bg-green-50">
//                       Accept
//                     </button>
//                     <button onClick={()=> changeJobApplicationStatus(applicant._id,'Rejected')} className="w-full text-left px-3 py-2 text-red-600 hover:bg-red-50">
//                       Reject
//                     </button>
//                   </div>
