...
//             <button  onClick ={applyHandler}className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md text-sm font-medium">
...
//   <button  onClick={applyHandler}className="bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 transition-all duration-200 text-white px-10 py-3 rounded-xl text-lg font-semibold shadow-md hover:shadow-xl">
//              {isAlreadyApplied ? 'Already applied' : ' Apply now'}
