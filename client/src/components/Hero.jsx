  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        <h2 className='text-2xl md:text-3xl lg:text-4xfont-medium mb-4'> 
            Over 10,000+ jobs to apply </h2>
     ...
     <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
        ...
        <button  onClick={onSearch}className='py-2 px-2 bg-blue-600 rounded text-white m-1'>Search</button>
     </div>
   </div>
     <div className="bg-white  border border-gray-300 rounded-xl shadow p-6 mx-2 mt-5 flex items-center justify-center gap-6">
